...
from application.api.batch.schema import CreateBatchRequestSchema, CreateBatchResponseSchema, GetBatchRequestSchema, GetBatchResponseSchema
...
def post_batch(schema: CreateBatchRequestSchema, repository: BaseRepository=Depends(init_repository)):
    try:
